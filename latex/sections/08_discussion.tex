...
MeanRankRevGrowth demonstrates successful reproduction under a controlled
C\&Z configuration, while an external standardized
configuration can still produce an opposite-sign result. ShareVol demonstrates the
...
materially configuration-sensitive; MeanRankRevGrowth is successfully
reproduced under the C\&Z configuration; and ShareVol's paper
coefficient cannot be identified with a portfolio-sort spread. Where complete factorial grids
