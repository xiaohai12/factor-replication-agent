#!/usr/bin/env python3
"""Backtest Script — ShareVol

Factor ID: cc376f708c404f89
...
CONFIG = {
    ...
    "universe_filters": [{'field': 'exchcd', 'op': 'eq', 'value': 1}],
    "unapplied_universe_filters": [{'concept_id': 'siccd', 'op': 'not_between', 'value': [6000, 6999], 'reason': 'The paper restricts the sample to non-financial firms but does not state an executable SIC-code range; 6000-6999 is the standard literature convention for financial firms.'}],
    ...
    "defaults_applied": [{'config_key': 'weighting_rule', 'value': 'vw', 'reason': 'MethodSpec field unspecified or off-menu; engine default applied', 'paper_value': 'other'}, {'config_key': 'missing_action', 'value': 'drop', 'reason': 'MethodSpec field unspecified or off-menu; engine default applied', 'paper_value': 'unspecified'}, {'config_key': 'formation_month', 'value': 6, 'reason': 'MethodSpec field unspecified; engine default applied', 'paper_value': None}],
}

FACTOR_ID = "cc376f708c404f89"
...
OUTPUT_PATH = "/Users/shengzhaolei/Desktop/shengzhao lei/projects/factor-replication-agent/runs/backtest_scripts/results/cc376f708c404f89/original_method.csv"
