...
Paper: Cooper, Michael J., Huseyin Gulen, and Michael J. Schill, 2008, Asset Growth and the Cross-Section of Stock Returns, Journal of Finance 63(4), 1609–1651.
...
CONFIG = {
    ...
    "universe_filters": [{'field': 'exchcd', 'op': 'in', 'value': [1, 2, 3]}, {'field': 'siccd', 'op': 'not_between', 'value': [6000, 6999]}, {'field': 'at', 'op': 'nonzero', 'value': None}],
    "unapplied_universe_filters": [{'concept_id': 'compustat_listing_years', 'op': 'gte', 'value': 2, 'reason': 'not applicable'}],
    "universe_filter_join_sources": {'compustat_fundamental_annual': ['at']},
    "transforms": [],
...
SIGNAL_INPUT_SOURCES = {'compustat_fundamental_annual': ['at']}  # multi_source only: {source: [columns]}
CRSP_FISCAL_YEAR_END_COLUMNS = []  # match fiscal month through CCM, then apply accounting lag
OUTPUT_PATH = "/Users/shengzhaolei/Desktop/Shengzhao_Lei/sideProject/factor-replication-agent/runs/backtest_scripts/results/099f6e1136bd316c/original_method.csv"
