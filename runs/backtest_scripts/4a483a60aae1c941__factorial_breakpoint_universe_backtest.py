...
CONFIG = {
    ...
    "universe_filters": [{'field': 'exchcd', 'op': 'in', 'value': [1, 2, 3]}, {'field': 'siccd', 'op': 'not_between', 'value': [6000, 6999]}, {'field': 'ceq', 'op': 'gt', 'value': 0}],
    "unapplied_universe_filters": [],
    "universe_filter_join_sources": {'compustat_fundamental_annual': ['ceq']},
    "transforms": [],
...
OUTPUT_PATH = "/Users/shengzhaolei/Desktop/shengzhao lei/projects/factor-replication-agent/runs/backtest_scripts/results/4a483a60aae1c941/factorial_breakpoint_universe.csv"
