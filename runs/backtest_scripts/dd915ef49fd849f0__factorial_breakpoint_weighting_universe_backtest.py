#!/usr/bin/env python3
"""Backtest Script — momentum

Factor ID: dd915ef49fd849f0
Paper: Jegadeesh, Narasimhan, and Sheridan Titman. 1993. "Returns to Buying Winners and Selling Losers: Implications for Stock Market Efficiency." The Journal of Finance 48(1): 65-91.

Auto-generated by factor-replication-agent.
This is a standalone script: run it with `python3 <filename>.py`

Signal input mode: crsp_only
...
SIGNAL_INPUT_MODE = "crsp_only"  # "compustat" | "crsp_only" | "multi_source"
...
SIGNAL_INPUT_SOURCES = {}  # multi_source only: {source: [columns]}
OUTPUT_PATH = "/Users/shengzhaolei/Desktop/Shengzhao_Lei/sideProject/factor-replication-agent/runs/backtest_scripts/results/dd915ef49fd849f0/factorial_breakpoint_weighting_universe.csv"
