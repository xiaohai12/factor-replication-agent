...
SIGNAL_INPUT_SOURCES = {'comp_funda': ['revt', 'cogs', 'at']}  # multi_source only: {source: [columns]}
OUTPUT_PATH = "/Users/shengzhaolei/Desktop/Shengzhao_Lei/sideProject/factor-replication-agent/runs/backtest_scripts/results/bed8718637a20b7b/standardized_hxz.csv"
