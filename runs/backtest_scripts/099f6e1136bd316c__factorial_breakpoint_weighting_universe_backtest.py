#!/usr/bin/env python3
"""Backtest Script — asset

Factor ID: 099f6e1136bd316c
...
CONFIG = {
    ...
    "unapplied_universe_filters": [{'concept_id': 'compustat_fiscal_year_end', 'op': 'gte', 'value': 2, 'reason': 'derivation not executable by the engine'}, {'concept_id': 'total_assets', 'op': 'nonzero', 'value': None, 'reason': 'derivation not executable by the engine'}],
...
SIGNAL_INPUT_SOURCES = {'comp_funda': ['at']}  # multi_source only: {source: [columns]}
OUTPUT_PATH = "/Users/shengzhaolei/Desktop/Shengzhao_Lei/sideProject/factor-replication-agent/runs/backtest_scripts/results/099f6e1136bd316c/factorial_breakpoint_weighting_universe.csv"
...
PRECOMPUTED_SIGNAL_PATH = ""  # optional; when set, skip compute_signal() (C&Z bridge track)
