...
CONFIG = {
    ...
    "universe_filters": [{'field': 'shrcd', 'op': 'in', 'value': [10, 11, 12]}, {'field': 'exchcd', 'op': 'in', 'value': [1, 2, 3]}, {'field': 'exchcd', 'op': 'eq', 'value': 1}],
...
OUTPUT_PATH = "/Users/shengzhaolei/Desktop/shengzhao lei/projects/factor-replication-agent/runs/backtest_scripts/results/cc376f708c404f89/cz_ablation_universe.csv"
