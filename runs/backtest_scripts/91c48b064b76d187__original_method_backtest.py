#!/usr/bin/env python3
"""Backtest Script — assetGrwoth

Factor ID: 91c48b064b76d187
...
CONFIG = {
    ...
    "universe_filters": [{'field': 'exchcd', 'op': 'in', 'value': [1, 2, 3]}, {'field': 'siccd', 'op': 'not_between', 'value': [6000, 6999]}],
    "unapplied_universe_filters": [{'concept_id': 'datadate', 'op': 'gte', 'value': 2, 'reason': 'The paper specifies a two-year Compustat-listing requirement but does not give a precise executable record-history calculation; this derived rule requires human confirmation before application.'}],
...
OUTPUT_PATH = "/Users/shengzhaolei/Desktop/Shengzhao_Lei/sideProject/factor-replication-agent/runs/backtest_scripts/results/91c48b064b76d187/original_method.csv"
