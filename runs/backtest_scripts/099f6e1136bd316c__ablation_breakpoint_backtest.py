...
CONFIG = {
    ...
    "unapplied_universe_filters": [{'concept_id': 'compustat_fiscal_year_end', 'op': 'gte', 'value': 2, 'reason': 'derivation not executable by the engine'}],
    "universe_filter_join_sources": {'comp_funda': ['at']},
    ...
    "defaults_applied": [{'config_key': 'missing_action', 'value': 'drop', 'reason': 'MethodSpec field unspecified or off-menu; engine default applied', 'paper_value': 'unspecified'}],
}
...
OUTPUT_PATH = "/Users/shengzhaolei/Desktop/Shengzhao_Lei/sideProject/factor-replication-agent/runs/backtest_scripts/results/099f6e1136bd316c/ablation_breakpoint.csv"
