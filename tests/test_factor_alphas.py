...
test (the real Ken French fetch lives in scripts/fetch_ff_factors.py and is
...
class TestComputeFactorAlphasEdgeCases:
    ...
    def test_none_factors_returns_empty(self):
        ...
        assert BacktestExecutor().compute_factor_alphas(ls, None, config={}) == {}
...
class TestComputeMetricsSharpeRatio:
    def test_sharpe_ratio_present_and_correct(self):
        ...
        metrics = BacktestExecutor().compute_metrics(series, config={})
